...
const About = () => {
  ...
  return (
    ...
    <div class="text-orange-600 text-4xl font-extrabold text-center mt-1">
        Placements
    </div>
...
<Carousel loop class="w-screen h-screen flex justify-center items-center">
        ...
        <Carousel.Item>
         ...
         <div class="text-slate-700 text-4xl px-8 font-extrabold ">
         Contact Us
         </div>
         ...
         <form  class=" text-2xl font-thin  " onSubmit={sendEmail}>

                  <div class=" px-[600px] grid gap-5 grid-cols-2">
                      <div class="">
                          <input type="text" name="full_name"
                          class="block lg:max-w-md font-normal px-2 py-1   focus:ring-purple-300 focus:outline-none focus:ring focus:ring-opacity-40  border border-red-400" placeholder="Your full name.." required/>
                      </div>

                      <div class=" px-[200px]">
                      <input type="email"  name="email"
                      class="block  lg:max-w-md  font-normal px-2 py-1   focus:ring-purple-300 focus:outline-none focus:ring focus:ring-opacity-40  border border-red-400" placeholder="Email" required/>
                  </div>

                  <div class=" ">
                      <input type="phone"  name="phone"
                      class="block  lg:max-w-md  font-normal px-2 py-1 mt-1 focus:ring-purple-300 focus:outline-none focus:ring focus:ring-opacity-40 border border-red-400" placeholder="Phone number" required/>
                  </div>

                      <div class=" text-center px-[200px]">
                    ...
                    <option value="usa">USA</option>
                      ...
                      <div class="">
                        <textarea name="message" class=" block text-sm py-20 px-32 border border-gray-300 focus:ring-blue-500 focus:border-blue-500  dark:border-gray-600 dark:placeholder-gray-400 dark:focus:ring-blue-500 dark:focus:border-blue-500  " placeholder="Write something.." ></textarea>
                      </div>
                      ...
                      <div className='row -mt-52 center text-center '> {result ? <Result/>:null}</div>
              </form>
              </div>
              </div>
         <Footer/>
